...
$string['pluginname'] = 'Stato';
$string['privacy:metadata'] = 'Il componente aggiuntivo Novità e avvisi non memorizza alcun dato personale.';
$string['all'] = 'Tutte le categorie';
...
$string['type_novelty:corrected_activities'] = 'Corretto';
$string['type_novelty:subscribed_forums'] = 'Iscrizioni';
$string['type_novelty:direct_response_forum'] = 'Risposte';
